...
class OrderRepository implements OrderRepositoryInterface
{
    public function findMany(object $payload, string $sortField, string $sortOrder)
    {
        ...
        return Order::filter($payload->all())
            ->with('shift.branch', 'customer', 'user', 'refundedBy', 'details.productVariant.product.category', 'details.discount', 'payments.user')
    ...
    {
        return Order::with('shift.branch', 'customer', 'user', 'refundedBy', 'details.productVariant.product.category', 'details.discount', 'payments.user')
            ->where('uuid', $uuid)
            ->firstOrFail();
    }
